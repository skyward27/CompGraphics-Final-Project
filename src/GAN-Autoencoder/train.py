...
dataroot = "C:/Users/haves/CompGraphics/FinalProject/cats/"
...
class Discriminator(nn.Module):
    def __init__(self, ngpu):
        ...
        self.ngpu = ngpu
        self.main = nn.Sequential(
            nn.Conv2d(256, ndf*4, 3,1,0,bias =False),
            ...
            nn.Conv2d(ndf * 16, 1, 2, stride=1, padding=0, bias=False),
            nn.Sigmoid()
        )
...
print(summary(netD, (1,256,10,10)))
# Handle multi-gpu if desired
if (device.type == 'cuda') and (ngpu > 1):
...
for epoch in range(num_epochs):
    ...
    for i, data in enumerate(dataloader, 0):
        ...
        real_cpu = model.encoder(real_cpu)
        ...
        iters += 1
    if (epoch+1) % 40 == 0:
        torch.save(netG.state_dict(), "generator/epoch" + str(epoch)+".pth")
        torch.save(netD.state_dict(), "discriminator/epoch" + str(epoch)+".pth")
